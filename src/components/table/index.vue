<template>
	<div class="tableMain">
		...
		>
			<el-table-column v-if="columnSelection" align="center" fixed="left" type="selection" width="70"></el-table-column>

			<el-table-column v-if="columnIndex" align="center" fixed="left" label="序号" type="index" width="55"></el-table-column>
